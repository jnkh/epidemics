...
# alpha_range = 10.0.^range(log10(0.01),stop=log10(1.5),length=10)#8*[0.005,0.01,0.02,0.04,0.06,0.1,0.15,0.25]#,0.3]#collect(0.01:0.1:0.5)
alpha_range = 10.0.^range(log10(0.01),stop=log10(1.5),length=5)#8*[0.005,0.01,0.02,0.04,0.06,0.1,0.15,0.25]#,0.3]#collect(0.01:0.1:0.5)
# alpha_range = linspace(0.01,1.0,10)#8*[0.005,0.01,0.02,0.04,0.06,0.1,0.15,0.25]#,0.3]#collect(0.01:0.1:0.5)
