...
if generate_data
   plot_beta = false
    ...
    # alpha_range = [0.05,0.15,0.18,0.2,0.22,0.25,0.28,0.5,1.0]#linspace(0.01,1.0,5)#8*[0.005,0.01,0.02,0.04,0.06,0.1,0.15,0.25]#,0.3]#collect(0.01:0.1:0.5)
